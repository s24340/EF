...
namespace EFsolution.Migrations
{
    ...
    [Migration("20240531172821_Initial")]
            ...
            modelBuilder.Entity("EF.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2024, 5, 31, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4744),
                            DueDate = new DateTime(2024, 8, 29, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4786),
                            IdDoctor = 1,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2024, 5, 31, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4793),
                            DueDate = new DateTime(2024, 7, 30, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4795),
                            IdDoctor = 1,
                            IdPatient = 3
                        },
                        new
                        {
                            IdPrescription = 3,
                            Date = new DateTime(2024, 5, 31, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4797),
                            DueDate = new DateTime(2024, 9, 28, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4799),
                            IdDoctor = 4,
                            IdPatient = 4
                        },
                        new
                        {
                            IdPrescription = 4,
                            Date = new DateTime(2024, 5, 31, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4802),
                            DueDate = new DateTime(2024, 8, 29, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4803),
                            IdDoctor = 4,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 5,
                            Date = new DateTime(2024, 5, 31, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4806),
                            DueDate = new DateTime(2024, 6, 30, 19, 28, 20, 818, DateTimeKind.Local).AddTicks(4807),
                            IdDoctor = 3,
                            IdPatient = 2
                        });
                });
